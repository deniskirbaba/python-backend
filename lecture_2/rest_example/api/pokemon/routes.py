...
from .contracts import (PokemonResponse, PokemonRequest, PatchPokemonRequest)
...
async def patch_pokemon(id: int, patch_info: PatchPokemonRequest) -> PokemonResponse:
    entity = store.patch(id, patch_info.as_patch_pokemon_info())
...
async def put_pokemon(id: int, 
                      info: PokemonRequest,
                      upsert: Annotated[bool, Query()] = False) -> PokemonResponse:
    entity = (
